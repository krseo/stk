# -*- coding: utf-8 -*-
"""
Created on Wed Jan 15 09:34:30 2020
...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        self.win001Act = QAction(QIcon(':/images/new.png'), "&Win001", self,
                shortcut=QKeySequence.New, statusTip="Create a new file",
                triggered=self.win001)
        
        self.win002Act = QAction(QIcon(':/images/new.png'), "&Win002", self,
                shortcut=QKeySequence.New, statusTip="Create a new file",
                triggered=self.win002)
    ...
    def createMenus(self):
        ...
        self.fileMenu.addAction(self.win001Act)
        self.fileMenu.addAction(self.win002Act)
